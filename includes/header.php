...
<head>
    ...
    <title><?= h($pageTitle) ?> · Expense Tracker</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-4">
    <div class="container">
        <a class="navbar-brand fw-semibold" href="<?= isLoggedIn() ? 'dashboard.php' : 'index.php' ?>">💰 Expense Tracker</a>
        ...
        <div class="collapse navbar-collapse" id="navMenu">
            <ul class="navbar-nav ms-auto">
                <?php if (isLoggedIn()): ?>
                    ...
                    <li class="nav-item"><span class="nav-link text-white-50">Hi, <?= h(currentUserName()) ?></span></li>
